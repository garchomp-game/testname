...
require './controllers/update_confirm_controller.rb'
require './controllers/delete_controller.rb'
require './controllers/delete_result_controller.rb'
...
map "/update_confirm" do
  run UpdateConfirmController.new
end
map '/delete' do
  run DeleteController.new
end
map '/delete_result' do
  run DeleteResultController.new
end
